...
Error: Invalid CSS after ".#{iv": expected "}", was ".$class-prefix}..."
        on line 3 of C:\realProject\node_modules\bulma\sass\helpers\overflow.scss

1: @use "../utilities/initial-variables" as iv;
2: 
3: .#{iv.$class-prefix}#{iv.$helpers-prefix}clipped {
4:   overflow: hidden !important;
5: }
6: 
7: $overflows: auto clip hidden scroll visible;
8: 

Backtrace:
C:\realProject\node_modules\bulma\sass\helpers\overflow.scss:3
...
body:before {
  ...
  content: "Error: Invalid CSS after \".#{iv\": expected \"}\", was \".$class-prefix}...\"\A         on line 3 of C:\realProject\node_modules\bulma\sass\helpers\overflow.scss\A \A 1: @use \"../utilities/initial-variables\" as iv;\A 2: \A 3: .#{iv.$class-prefix}#{iv.$helpers-prefix}clipped {\A 4:   overflow: hidden !important;\A 5: }\A 6: \A 7: $overflows: auto clip hidden scroll visible;\A 8: "; }
