...
Error: Invalid CSS after ".#{iv": expected "}", was ".$class-prefix}..."
        on line 4 of C:\realProject\node_modules\bulma\sass\helpers\float.scss

1: @use "../utilities/initial-variables" as iv;
2: @use "../utilities/mixins" as mx;
3: 
4: .#{iv.$class-prefix}#{iv.$helpers-prefix}clearfix {
5:   @include mx.clearfix;
6: }
7: 
8: .#{iv.$class-prefix}#{iv.$helpers-prefix}float-left,
9: .#{iv.$class-prefix}#{iv.$helpers-prefix}pulled-left {

Backtrace:
C:\realProject\node_modules\bulma\sass\helpers\float.scss:4
...
body:before {
  ...
  content: "Error: Invalid CSS after \".#{iv\": expected \"}\", was \".$class-prefix}...\"\A         on line 4 of C:\realProject\node_modules\bulma\sass\helpers\float.scss\A \A 1: @use \"../utilities/initial-variables\" as iv;\A 2: @use \"../utilities/mixins\" as mx;\A 3: \A 4: .#{iv.$class-prefix}#{iv.$helpers-prefix}clearfix {\A 5:   @include mx.clearfix;\A 6: }\A 7: \A 8: .#{iv.$class-prefix}#{iv.$helpers-prefix}float-left,\A 9: .#{iv.$class-prefix}#{iv.$helpers-prefix}pulled-left {"; }
