...
Error: Invalid CSS after ".#{iv": expected "}", was ".$class-prefix}..."
        on line 4 of C:\realProject\node_modules\bulma\sass\helpers\position.scss

1: @use "../utilities/extends";
2: @use "../utilities/initial-variables" as iv;
3: 
4: .#{iv.$class-prefix}#{iv.$helpers-prefix}overlay,
5: .#{iv.$class-prefix}#{iv.$helpers-prefix}overlay {
6:   @extend %overlay;
7: }
8: 
9: .#{iv.$class-prefix}#{iv.$helpers-prefix}relative {

Backtrace:
C:\realProject\node_modules\bulma\sass\helpers\position.scss:4
...
body:before {
  ...
  content: "Error: Invalid CSS after \".#{iv\": expected \"}\", was \".$class-prefix}...\"\A         on line 4 of C:\realProject\node_modules\bulma\sass\helpers\position.scss\A \A 1: @use \"../utilities/extends\";\A 2: @use \"../utilities/initial-variables\" as iv;\A 3: \A 4: .#{iv.$class-prefix}#{iv.$helpers-prefix}overlay,\A 5: .#{iv.$class-prefix}#{iv.$helpers-prefix}overlay {\A 6:   @extend %overlay;\A 7: }\A 8: \A 9: .#{iv.$class-prefix}#{iv.$helpers-prefix}relative {"; }
