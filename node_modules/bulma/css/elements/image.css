...
Error: Invalid CSS after ".#{iv": expected "}", was ".$class-prefix}..."
        on line 9 of C:\realProject\node_modules\bulma\sass\elements\image.scss

4: @use "../utilities/css-variables" as cv;
5: @use "../utilities/mixins" as mx;
6: 
7: $dimensions: 16 24 32 48 64 96 128 !default;
8: 
9: .#{iv.$class-prefix}image {
10:   display: block;
...
Backtrace:
C:\realProject\node_modules\bulma\sass\elements\image.scss:9
...
body:before {
  ...
  content: "Error: Invalid CSS after \".#{iv\": expected \"}\", was \".$class-prefix}...\"\A         on line 9 of C:\realProject\node_modules\bulma\sass\elements\image.scss\A \A 4: @use \"../utilities/css-variables\" as cv;\A 5: @use \"../utilities/mixins\" as mx;\A 6: \A 7: $dimensions: 16 24 32 48 64 96 128 !default;\A 8: \A 9: .#{iv.$class-prefix}image {\A 10:   display: block;\A 11:   position: relative;\A 12: \A 13:   img {\A 14:     display: block;"; }
