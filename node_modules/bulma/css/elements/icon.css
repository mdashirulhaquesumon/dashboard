/*
Error: Invalid CSS after ".#{iv": expected "}", was ".$class-prefix}..."
        on line 10 of C:\realProject\node_modules\bulma\sass\elements\icon.scss

5: $icon-dimensions-small: 1rem !default;
6: $icon-dimensions-medium: 2rem !default;
7: $icon-dimensions-large: 3rem !default;
8: $icon-text-spacing: 0.25em !default;
9: 
10: .#{iv.$class-prefix}icon,
11: .#{iv.$class-prefix}icon-text {
12:   @include cv.register-vars(
13:     (
14:       "icon-dimensions": #{$icon-dimensions},
15:       "icon-dimensions-small": #{$icon-dimensions-small},

Backtrace:
C:\realProject\node_modules\bulma\sass\elements\icon.scss:10
...
C:/Program Files (x86)/Koala/rubygems/gems/sass-3.5.2/lib/sass/script/parser.rb:730:in `assert_tok'
C:/Program Files (x86)/Koala/rubygems/gems/sass-3.5.2/lib/sass/script/parser.rb:52:in `parse_interpolated'
C:/Program Files (x86)/Koala/rubygems/gems/sass-3.5.2/lib/sass/scss/parser.rb:1134:in `sass_script'
C:/Program Files (x86)/Koala/rubygems/gems/sass-3.5.2/lib/sass/scss/parser.rb:1047:in `interpolation'
C:/Program Files (x86)/Koala/rubygems/gems/sass-3.5.2/lib/sass/scss/parser.rb:877:in `almost_any_value_token'
C:/Program Files (x86)/Koala/rubygems/gems/sass-3.5.2/lib/sass/scss/parser.rb:853:in `almost_any_value'
C:/Program Files (x86)/Koala/rubygems/gems/sass-3.5.2/lib/sass/scss/parser.rb:669:in `ruleset'
...
body:before {
  ...
  content: "Error: Invalid CSS after \".#{iv\": expected \"}\", was \".$class-prefix}...\"\A         on line 10 of C:\realProject\node_modules\bulma\sass\elements\icon.scss\A \A 5: $icon-dimensions-small: 1rem !default;\A 6: $icon-dimensions-medium: 2rem !default;\A 7: $icon-dimensions-large: 3rem !default;\A 8: $icon-text-spacing: 0.25em !default;\A 9: \A 10: .#{iv.$class-prefix}icon,\A 11: .#{iv.$class-prefix}icon-text {\A 12:   @include cv.register-vars(\A 13:     (\A 14:       \"icon-dimensions\": #{$icon-dimensions},\A 15:       \"icon-dimensions-small\": #{$icon-dimensions-small},"; }
