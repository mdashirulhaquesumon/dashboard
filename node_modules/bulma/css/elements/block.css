...
Error: Invalid CSS after ".#{iv": expected "}", was ".$class-prefix}..."
        on line 4 of C:\realProject\node_modules\bulma\sass\elements\block.scss

1: @use "../utilities/initial-variables" as iv;
2: @use "../utilities/extends";
3: 
4: .#{iv.$class-prefix}block {
5:   @extend %block;
6: }

Backtrace:
C:\realProject\node_modules\bulma\sass\elements\block.scss:4
...
body:before {
  ...
  content: "Error: Invalid CSS after \".#{iv\": expected \"}\", was \".$class-prefix}...\"\A         on line 4 of C:\realProject\node_modules\bulma\sass\elements\block.scss\A \A 1: @use \"../utilities/initial-variables\" as iv;\A 2: @use \"../utilities/extends\";\A 3: \A 4: .#{iv.$class-prefix}block {\A 5:   @extend %block;\A 6: }"; }
