/*
Error: Invalid CSS after "...round-color: cv": expected selector or at-rule, was ".getVar("scheme..."
        on line 5 of C:\realProject\node_modules\bulma\sass\elements\box.scss

1: @use "../utilities/css-variables" as cv;
2: @use "../utilities/initial-variables" as iv;
3: @use "../utilities/extends";
4: 
5: $box-background-color: cv.getVar("scheme-main") !default;
6: $box-color: cv.getVar("text") !default;
7: $box-radius: cv.getVar("radius-large") !default;
8: $box-shadow: cv.getVar("shadow") !default;
9: $box-padding: 1.25rem !default;
10: 

Backtrace:
C:\realProject\node_modules\bulma\sass\elements\box.scss:5
...
body:before {
  ...
  content: "Error: Invalid CSS after \"...round-color: cv\": expected selector or at-rule, was \".getVar(\"scheme...\"\A         on line 5 of C:\realProject\node_modules\bulma\sass\elements\box.scss\A \A 1: @use \"../utilities/css-variables\" as cv;\A 2: @use \"../utilities/initial-variables\" as iv;\A 3: @use \"../utilities/extends\";\A 4: \A 5: $box-background-color: cv.getVar(\"scheme-main\") !default;\A 6: $box-color: cv.getVar(\"text\") !default;\A 7: $box-radius: cv.getVar(\"radius-large\") !default;\A 8: $box-shadow: cv.getVar(\"shadow\") !default;\A 9: $box-padding: 1.25rem !default;\A 10: "; }
